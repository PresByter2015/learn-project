...
Game.importPrettify = function() {
  ...
  link.setAttribute('href', 'prettify-1.css'/*tpa=http://www.jnschool.com/html/lessons/blockly2/js/prettify/prettify.css*/);
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('src', 'prettify-1.js'/*tpa=http://www.jnschool.com/html/lessons/blockly2/js/prettify/prettify.js*/);
...
Game.importGameScript = function() {
	var script = '';
	if (Game.NAME == 'maze') {
		script = ['<script type="text/javascript" src="maze.js"/*tpa=http://www.jnschool.com/html/lessons/blockly2/js/js/maze.js*/></script>\n',
		'<script type="text/javascript" src="maze.source.js"/*tpa=http://www.jnschool.com/html/lessons/blockly2/js/js/maze.source.js*/></script>\n',
		'<script type="text/javascript" src="maze.draw.js"/*tpa=http://www.jnschool.com/html/lessons/blockly2/js/js/maze.draw.js*/></script>\n',
		'<script type="text/javascript" src="maze.core.js"/*tpa=http://www.jnschool.com/html/lessons/blockly2/js/js/maze.core.js*/></script>\n'].join('');
	}else if (Game.NAME == 'painting') {
		script = '<script type="text/javascript" src="painting.js"/*tpa=http://www.jnschool.com/html/lessons/blockly2/js/js/painting.js*/></script>';
	}else {
