...
fn.get_offset = function(e) {
  ...
  if (this.options.limit) {
    if (left < this.player_min_left) {
      left = this.player_min_left;
    } else if (left > this.player_max_left) {
      left = this.player_max_left;
    }

    if (top < this.player_min_top) {
      top = this.player_min_top
    } else if (top > this.player_max_top) {
...
fn.set_limits = function(container_width) {
  ...
  this.player_max_top = (containerHeight - this.player_height +
...
fn.resize = function(opts) {
  this.options.container_width = opts.width
}
