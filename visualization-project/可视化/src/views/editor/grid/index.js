  ...
  getGridBoxStyle(contentWrapSize, gridSize, marginRow) {
    ...
    if (contentWrapSize) {
      if (contentWrapSize.height) {
        ...
        let diffHeight = contentWrapSize.height - gridSize.height - constants.GRID_BORDER;

        gridBoxStyle[0] = diffHeight;
      }
    ...
    if (this.props.isFullScreen) {
      ...
      style.margin = `28px ${gridBoxStyle[1]}px`;
      // style.margin = `0 ${gridBoxStyle[1]}px ${gridBoxStyle[0]}px`//top为0
    }
