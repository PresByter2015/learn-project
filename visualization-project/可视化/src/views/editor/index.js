...
class Editor extends Component {
  ...
  calcSize() {
    ...
    let panelWidth = constants.PANEL_WIDTH;
    let widgetWidth = constants.WIDGET_WIDTH;
    let headerHeight = constants.WINDOW_HEADER_HEIGHT;
    let publicHeaderHeight = constants.PUBLIC_HEADER_HEIGHT;
  ...
  getContentWrapSize() {
    ...
    return {
      ...
      height: this.getContainerHeight() - constants.PUBLIC_HEADER_HEIGHT
    };
  }
  ...
  componentDidMount() {
    Dom.body.attr('data-page', 'editor');
  ...
  render() {
    ...
    let containerStyle = {
      position: 'relative',
      zIndex: 9,
      height: panelSize.height + constants.WINDOW_HEADER_HEIGHT,
      overflow: 'hidden'
    };
    ...
    return (
      <div className="page-editor">
        <section ref="container" style={containerStyle}>
          ...
          {canOperate ?
            <Tool zoom={this.state.zoom} onZoom={this.handleZoom.bind(this)}/>
            : null
          }
          ...
          <div className="editor-wrap">
            {canOperate ?
              <div className="widget-wrap"
                   onMouseLeave={this.handleHideNavPanel.bind(this)}>
                {/* 这块是右侧导航栏的选项 */}
                <Widget/>
                {/* 这块是鼠标移入后出现的选项 */}
                <NavPanel/>
